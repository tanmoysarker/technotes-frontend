...
export default class EditNote extends Component {
    ...
    handleSave(e) {
        var token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjMiLCJyb2xlcyI6ZmFsc2UsInRpbWV6b25lIjoiQW1lcmljYS9Nb250cmVhbCIsImV4cCI6MTYyMzYxMzc1OH0.elpIntooQgFNOC7xzbKePC_RsASBD9JDtPTpiu9mPvE'

        e.preventDefault();
        // Make an api call to create a new note
        axios.post('https://technotes-api.herokuapp.com/api/v1/note',{
            headers: {
